...
### Fig. 2b
python analyseFluxes.py -i "${MOMAPFBADIR}/endOfSimulation-ecoli_core-batch_low_Glc-moma_notrans_mono_ECgl.p ${MOMAPFBADIR}/endOfSimulation-ecoli_core-batch_low_Glc-pfba_notrans_mono_ECgl.p" -C -l 'MOMA pFBA' -p ${OUTDIR} -r "${rxns}" -G -k 0.51
